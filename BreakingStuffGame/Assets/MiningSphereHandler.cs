...
public class MiningSphereHandler : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKey(KeyCode.L)) // Check for left mouse button click
        {
    ...
    {
        if (collision.CompareTag("Ground") && hit)
        {
            terrainhandler.RemoveTile(collision.position);
        }
    }*/
}
